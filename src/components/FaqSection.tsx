...
const faqs = [
  ...
  },
  {
    ...
    a: 'В тарифе «Бизнес» включены плановое ТО, чистка и настройка машины, а также выезд мастера до 2 раз и замена машины на период ремонта.',
  },
  {
  ...
  },
  {
    ...
    a: 'Минимальный срок — 1 месяц для тарифа «Бизнес», 3 месяца — для тарифа «Старт». При аренде от 6 месяцев действует скидка 8%, от 12 месяцев — 15%.',
  },
  {
    q: 'Нужно ли самостоятельно покупать кофе и расходники?',
    a: 'Расходные материалы оплачиваются отдельно — мы предлагаем широкий ассортимент зёрнового кофе, капсул и молока по выгодным ценам.',
  },
  {
  ...
  },
  {
    ...
    a: 'В тарифе «Бизнес» мастер выедет в течение 48 часов. На период ремонта предоставляется временная замена машины.',
  },
];
